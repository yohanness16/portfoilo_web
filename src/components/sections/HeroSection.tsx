        ...
        >
          <div style={{ 
            ...
            <div data-anim style={{ opacity: 0 }}>
              ...
              >
                <span className="hero-flicker" style={{ color: 'var(--red)' }}>YOHANNES</span><br /> <span className="hero-flicker" style={{ color: '#fff' }}>DESALEGN</span>
              </h1>
            </div>
          ...
          <div className="hero-pendulum-wrapper" style={{ flex: isMobile ? 'none' : '0.8', width: '100%' }}>
            <div
              data-anim
              className={isMobile ? "" : "hero-pendulum"}
              style={{
